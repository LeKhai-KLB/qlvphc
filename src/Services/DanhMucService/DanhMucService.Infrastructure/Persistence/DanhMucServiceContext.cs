...
public class DanhMucServiceContext : DbContext
{
    ...
    public DanhMucServiceContext(DbContextOptions<DanhMucServiceContext> options, ILogger logger, IMediator mediator) : base(options)
    {
        _logger = logger;
        _mediator = mediator;
    }
