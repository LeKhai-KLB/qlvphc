...
using DanhMucService.Application.Features.V1.TinhThanhPhos.Commands.CreateTinhThanhPho;
using DanhMucService.Application.Features.V1.TinhThanhPhos.Commands.DeleteTinhThanhPho;
using DanhMucService.Application.Features.V1.TinhThanhPhos.Commands.UpdateTinhThanhPho;
using DanhMucService.Application.Features.V1.TinhThanhPhos.Queries.GetTinhThanhPhoById;
using DanhMucService.Application.Features.V1.TinhThanhPhos.Queries.GetTinhThanhPhos;
using DanhMucService.Application.Features.V1.TinhThanhPhos.Queries.GetTinhThanhPhosByTerm;
